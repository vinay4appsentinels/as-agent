...
declare global {
  const ASAGENT_VERSION: string
  const ASAGENT_CHANNEL: string
}
...
export namespace Installation {
  ...
  export const VERSION = typeof ASAGENT_VERSION === "string" ? ASAGENT_VERSION : "local"
  export const CHANNEL = typeof ASAGENT_CHANNEL === "string" ? ASAGENT_CHANNEL : "local"
