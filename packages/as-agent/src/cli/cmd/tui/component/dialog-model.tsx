            ...
            return [
              {
                ...
                category: "Recent",
                footer: model.cost?.input === 0 && provider.id === "as-agent" ? <Free /> : undefined,
              },
            ]
          })
        : []),
        ...
        flatMap((provider) =>
          pipe(
            ...
            map(([model, info]) => ({
              ...
              footer: info.cost?.input === 0 && provider.id === "as-agent" ? <Free /> : undefined,
            })),
